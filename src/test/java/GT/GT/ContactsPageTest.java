...
@Test
	public void verifySwitchingBetweenPhoneContactsAndWeblist() throws InterruptedException {
		...
		Boolean isPhoneContactsTabClickedOrNot=contactsPage.clickOnPhoneContactsBtn();
		logger_ss.log(Status.INFO, "Clicked on phone contacts tab");
		Assert.assertTrue(isPhoneContactsTabClickedOrNot);
		Boolean isWeblistTabClickedOrNot=contactsPage.clickOnWebListBtn();
		logger_ss.log(Status.INFO, "Clicked on Weblist  tab");
		Assert.assertTrue(isWeblistTabClickedOrNot);
		}
	...
	public void verifyCreateListFromContactsPageUsingPlusSymbol() throws InterruptedException {
		logger_ss = extent.createTest("verifyCreateListFromContactsPageUsingPlusSymbol",
				"verify Create List From Contacts Page UsingPlusSymbol");
		ContactsPage contactsPage = new ContactsPage();
		contactsPage.clickOnContactsTab();
		logger_ss.log(Status.INFO, "Clicked on contacts tab in myGrpTalks page");
	...
	public void verifyCreateListFromExcelUploadviaedit() throws InterruptedException, AWTException {
		logger_ss = extent.createTest("verifyCreateListFromExcelUploadviaedit",
				"verifyCreateListFromExcelUploadviaedit");
		ContactsPage contactsPage = new ContactsPage();
		contactsPage.clickOnContactsTab();
		logger_ss.log(Status.INFO, "Clicked on contacts tab in myGrpTalks page");
		...
		// Assert.assertEquals(contactsPage.successMsgForCreatedWebListFromExcelUpload(),
		// "Contact(s) Inserted Successfully");
		// logger_ss.log(Status.INFO, "verified
		// successMsgForCreatedWebListFromExcelUpload");
		// boolean result=contactsPage.selectRecentlyCreatedList(listName);
		// logger_ss.log(Status.INFO, "Successfully selected Recently Created
		// List");
		// Assert.assertTrue(result);
		// Assert.assertEquals(contactsPage.listOfContactsInWebList(), 2);
		// logger_ss.log(Status.INFO, "Successfully verified the
		// listOfContactsInWebList");
		// logger_ss.log(Status.INFO, "Successfully verified the functionality
		// of CreateListFromExcelUpload");
	...
	public void verifyAddContactsFromAddContactsTabOnOverlay() throws InterruptedException {
		logger_ss = extent.createTest("verifyAddContactsFromAddContactsTabOnOverlay",
				"verify Add Contacts From Add Contacts Tab On Overlay");
		ContactsPage contactsPage = new ContactsPage();
		contactsPage.clickOnContactsTab();
		logger_ss.log(Status.INFO, "Clicked on contacts tab in myGrpTalks page");
		contactsPage.clickOnCreateNewGrpListButton();
	...
	public void verifyAddContactsFromWebListsTabOnOverlay() throws InterruptedException {
		logger_ss = extent.createTest("verifyAddContactsFromWebListsTabOnOverlay",
				"verify Add Contacts From WebLists Tab On Overlay");
		ContactsPage contactsPage = new ContactsPage();
		contactsPage.clickOnContactsTab();
		logger_ss.log(Status.INFO, "Clicked on contacts tab in myGrpTalks page");
		contactsPage.clickOnCreateNewGrpListButton();
	...
	public void verifyAddContactsFromMobileContactsTabOnOverlay() throws InterruptedException {
		logger_ss = extent.createTest("verifyAddContactsFromMobileContactsTabOnOverlay",
				"verify Add Contacts From Mobile Contacts Tab On Overlay");
		ContactsPage contactsPage = new ContactsPage();
		contactsPage.clickOnContactsTab();
		logger_ss.log(Status.INFO, "Clicked on contacts tab in myGrpTalks page");
		contactsPage.clickOnCreateNewGrpListButton();
	...
	public void verifyDeleteAddedContactsFromAddContactsTabOnOverlay() throws InterruptedException {
		...
		logger_ss.log(Status.INFO,
				"Successfully verified the functionality of DeleteAddedContactsFromAddContactsTabOnOverlay");
	}
	...
	public void verifyAddduplicateContactsFromAddContactsTabOnOverlay() throws InterruptedException {
		logger_ss = extent.createTest("verifyAddduplicateContactsFromAddContactsTabOnOverlay",
				"verifyAddduplicateContactsFromAddContactsTabOnOverlay");
		ContactsPage contactsPage = new ContactsPage();
		contactsPage.clickOnContactsTab();
		logger_ss.log(Status.INFO, "Clicked on contacts tab in myGrpTalks page");
		contactsPage.clickOnCreateNewGrpListButton();
