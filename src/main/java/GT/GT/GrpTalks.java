...
public class GrpTalks extends BrowserFunctions {
	...
	By hostNumber = By
			.cssSelector("#liveCallMembers [class='col-xs-4 col-sm-3 oncall-admin']:nth-of-type(1) .persn-phnm-det");// div[@id='liveCallMembers']/div[1]/div[@class='persn-phnm-det']
	By exceptHost = By.xpath("//*[@class=\"oncall-admin-inprogress\"]"); // //*[@id='foradmincheck']//*[@for='r1s']//*[@class='persn-phnm-det']
	By allMembers = By.xpath("//*[@class=\"col-xs-4 col-sm-3 oncall-admin\"]//*[@class=\"persn-phnm-det\"]");
	...
	By listLiveCallMembers = By.xpath("//span[@class=\"bxCircular green\"]"); //// col-sm-3
	...
	By historyOfGroupCall = By
			.xpath("//*[contains(@class,'ui-accordion-header ui-state-default ui-corner-all ui-accordion-icons')]");
	By grpCallDurationInHistoryTab = By.xpath(
			"//*[@class='ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active']/div/div[1]/ul/li[1]");
	...
	By totalAmountChargedForGrpcall = By.xpath("//span[contains(text(),\"INR\")]");
	...
	By downloadRecordingButton = By
			.xpath("//*[@class=\"pull-left clip-down\"]//*[@class=\"fa fa-download margin-right-5 btn clipDownload\"]");// xpath("//*[@class='margin-bottom-20']//*[@title='Download
																														// Recording']");
	By contactsListOfGroupOnMyGrpTalkPage = By
			.xpath("//*[@id='members']//*[@class='col-xs-6 col-sm-4 col-md-3 col-mgbtm']");
	By quickDialButtonOfActiveGroup = By.xpath("//*[@class=\"quickDials\" and @id=\"quickDial\"]");
	...
	// col-sm-3 oncall-admin']");
	// By participnatsNames = By.xpath("//*[@class='persn-name-det-calling']");
	// By participantsNumbers =
	// By.xpath("//*[@id='liveCallMembers']//*[@class='persn-phnm-det']");
	// By hostSymbol = By.xpath("//*[@id='liveCallMembers']//*[@class='col-xs-4
	// col-sm-3 oncall-admin']//*[@class='admin-ico-bg pull-left']");
	...
	// By handRaiseEnabledSymbol =
	// By.xpath("//*[@src='images/handRiseNew.png']");
	...
	By individualOnCallParticipants = By.xpath(
			"//span[@class=\"oncall-bg bgGreen pull-right mr-2\"]//span[@class=\"oncall-text text-left\" and text()=\"ON CALL\"]");
	//// *[@class='oncall-bg bgGreen pull-right mr-2']//*[@class='oncall-text
	//// text-left']
	...
	// pull-right mr-2");
	// By callEndedParticipants =
	// By.xpath("//*[@id='liveCallMembers']//*[@class='col-xs-4 col-sm-3
	// oncall-admin']");
	// By hostInAllParticipantsTab =
	// By.xpath("//*[@id='liveCallMembers']//*[@class='col-xs-4 col-sm-3
	// oncall-admin']");
	// By membersInAllParticipantsTabWithHost =
	// By.xpath("//*[@id='liveCallMembers']//*[contains(@class,'col-xs-4
	// col-sm-3 oncall-admin']");
	...
	// fa-user']");
	By privateRoomOption = By
			.xpath("//*[@class='col-xs-4 col-sm-3 oncall-admin oncall-admin-inprogre ss']//*[@class='fa fa-lock']");
	By moveBackTocallButton = By.xpath("//a[@id='privateUnPrivate']");
	...
	By allParticipantsInListViewExceptHost = By
			.xpath("//*[@class='table tblList']//*[@class='oncall-admin-inprogress']");
	...
	By hangUpParticipantsExceptHostInlistView = By
			.xpath("//*[@class='table tblList']//*[@class='oncall-admin-inprogress']//*[@class='singleHangUp']");
	...
	By insuranceType = By
			.xpath("//*[@class='modal fade modal-page in']//*[@class='wrapper']//*[@class='list-group-item']");
	By backButton = By.xpath("//*[@class='icon ion-android-arrow-back']");
	By privateRoomButton = By.xpath("//*[@id=\"privateUnPrivate\"]//*[@class='fa fa-lock']");
	By hangUpButtonOfParticipant = By.xpath(" //*[@class='singleHangUp']");
	...
	By privateRoomOptionOfPaticipantInListView = By
			.xpath("//td[@class='text-center privateRoomBadgeTb']//span[@class='pull - left private_icn']");
	...
	By secondaryModeratorSymbol = By.xpath("//*[@class=\"fa fa-star \" and @title=\"Secondary Moderator\"]");
	By allMembersInGrpTalksPage = By
			.xpath("//*[@class='col-xs-6 col-sm-4 col-md-3 col-mgbtm']//*[@id='foradmincheck']");
	...
	public void listViewPrivateRoom() throws InterruptedException {
		...
		Thread.sleep(3000);
		List<WebElement> getOneMember = driver.findElements(exceptHost);
		for (WebElement ele : getOneMember) {
			ele.click();
			if (i == 1) {
				break;
			}
		...
		CommonMethods.explicitWaitForElementVisibility(privateRoomButton);
		driver.findElement(privateRoomButton).click();
	}

	public void moveToPrivateRoom() {
	...
	public void gotoListViwe() {
		CommonMethods.explicitWaitForElementVisibility(listView);
	...
	public List<String> getAllMembers() throws InterruptedException {
		...
		return allMembersListString;
	}

	public int getListViewLiveCallMembers() {
		int onCall = 0;
		onCall = driver.findElements(listViewOnCallMembers).size();
		return onCall;
	}

	public void getCreatedGroup(String grapName) throws InterruptedException {
		Thread.sleep(5000);
		driver.navigate().refresh();
		driver.findElement(searchGroup).sendKeys(grapName);
	}

	public void selectScheduleGroupFromGroupsList() {
		List<WebElement> ele = driver.findElements(groupsList);
		for (WebElement ele1 : ele) {
			String grpName = ele1.getText();
			ele1.click();
	...
	public boolean checkSecondaryModerator(String name) {
		...
		for (int j = 0; j < membersList.size(); j++) {
			// WebElement kk=
			// membersList.get(j).findElement(By.xpath("//*[@class='persn-name-det']"));
			// System.out.println(kk);
			System.out.println(membersList.get(j).findElement(By.xpath(".//*[@class='persn-name-det']")).getText());
			if (membersList.get(j).findElement(By.xpath(".//*[@class='persn-name-det']")).getText()
	...
	// public void removeAddedContactFromGroupInOnGoingCall() throws
	...
	// selectedContactsTab();
	// List<WebElement>
	// selectedUsers=driver.findElements(By.xpath("//div[@id='selectedContacts']//div/div[2]/p[1]"));
	// for(WebElement user: selectedUsers){
	// if(user.getText().equalsIgnoreCase("7396206647") ||
	// user.getText().contains("Ivy Ajay")){
	// user.click();
	// break;
	// }
	//
	...
	public void clickOnScheduleCancleButton() throws InterruptedException {
		CommonMethods.explicitWaitForElementVisibility(scheduleCancleButton);
		driver.findElement(scheduleCancleButton).click();
	}
	...
	public int groupTotalDialOutMinsOnHistory() throws InterruptedException {
		List<WebElement> column = driver.findElements(By.xpath(
				"//*[contains(@class,'ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-activ')]//table/tbody/tr/td[3]"));
		int count = 0;
		int row_num = 1;
	...
	public double totalAmountChargedForGroupOnHistory() throws InterruptedException {
		List<WebElement> column = driver.findElements(By.xpath(
				"//*[contains(@class,'ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-activ')]//table/tbody/tr/td[4]"));
		double count = 0;
		int row_num = 1;
		for (WebElement tdElement : column) {
			String s = tdElement.getText();
	...
	// public String retrievingNameOfCreatedGrpTalk() throws
	// InterruptedException{
	// return name;
	// }
	...
	public boolean checkRecentlySavedGrpTalkGroup(String grpName) throws InterruptedException {
		// String ss=name;
		Thread.sleep(1000);
		// Assert.assertTrue(CommonMethods.elementExistsOrNot(CreatingGroup.createdGrplist));
		List<WebElement> listofGrpnames = driver.findElements(createdGrplist);
	...
	public void selectSavedGroupByName(String grpName) throws InterruptedException {
		...
		String savedGrpName = grpName;
		Thread.sleep(3000);
		driver.findElement(searchGroup).sendKeys(savedGrpName);
		List<WebElement> listofUsersInGroup = driver.findElements(createdGrplist);
	...
	// public String successMsgForDeletingSavedGroup() throws
	// InterruptedException{
	...
	public int verifyLiveCallState() throws InterruptedException {
	...
	public void hangUpCurrentGrpTalkcall() throws InterruptedException {
		...
		//
		// driver.findElement(By.xpath("//*[@class=\"mt-10 mb-20
		// text-center\"]//*[@reasonid=\"12\"]")).click();
	...
	public void addMemberInOnGoingGrpCall() throws InterruptedException {
		...
		driver.findElement(enternameforaddingparticipanttoGroupcall)
				.sendKeys(CommonMethods.passingData("AddContactInOnGoingCall"));
		driver.findElement(enterNewNumberForAddingToGroupCall)
				.sendKeys(CommonMethods.passingData("AddContactInOnGoingCall"));
		Thread.sleep(1000);
	...
	// public boolean cancleButtonDisplayedOnCallOverlay() throws
	// InterruptedException{
	// CommonMethods.explicitWaitForElementVisibility(cancelGroupCallButtonOnOverlay);
	// return driver.findElement(cancelGroupCallButtonOnOverlay).isDisplayed();
	// }

	// public boolean muteDialButtonDisplayedOnCallOverlay() throws
	// InterruptedException{
	// CommonMethods.explicitWaitForElementVisibility(muteDialGroupCallButtonOnOverlay);
	// return
	// driver.findElement(muteDialGroupCallButtonOnOverlay).isDisplayed();
	// }

	// public boolean dialGroupButtonDisplayedOnCallOverlay() throws
	// InterruptedException{
