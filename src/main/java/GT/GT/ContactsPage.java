...
public class ContactsPage extends BrowserFunctions{
	...
	By contactsTab 							= By.xpath("//*[@id='contacts-li']/a");
 	...
 	By weblistTab=By.xpath("//*[@id='contactsTab']//*[@class='webContacts']");
 	By phoneContactsTab=By.xpath("//*[@id='contactsTab']//*[@class='mobileContacts']");
 	
 	public Boolean clickOnWebListBtn() throws InterruptedException{
 		Thread.sleep(500);
 		WebElement ele=driver.findElement(weblistTab);
	...
	public Boolean clickOnPhoneContactsBtn() throws InterruptedException{
 		Thread.sleep(500);
 		WebElement ele=driver.findElement(phoneContactsTab);
 		boolean result=false;
 		if(ele.isDisplayed()){
 			ele.click();
 			return result=true;
